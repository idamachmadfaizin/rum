...
<body style="background-color:#F1F2F7;">
		...
		<nav class="navbar navbar-expand-sm navbar-default">
			<div id="main-menu" class="main-menu collapse navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<li><a href="#" class=""><i class="menu-icon fa fa-cogs"></i>Category</a></li>
												...
												<tr class=" pb-0">
													...
													<td>
														<div class="btn-group">
															...
															<div class="dropdown-menu" style="margin-top:-80px;"><!-- change this -->
																<a class="dropdown-item" href="#">BELUM</a>
																<a class="dropdown-item" href="#">DIBAYAR</a>
															</div>
														</div>
	...
	<script src="<?= base_url()?>assets/elaadmin/js/init/weather-init.js"></script>

	<script src="https://cdn.jsdelivr.net/npm/moment@2.22.2/moment.min.js"></script>
	<script src="https://cdn.jsdelivr.net/npm/fullcalendar@3.9.0/dist/fullcalendar.min.js"></script>
	<script src="<?= base_url()?>assets/elaadmin/js/init/fullcalendar-init.js"></script>

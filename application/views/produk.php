								...
								<div class="rs2-select2 bo4 of-hidden w-size12 m-t-5 m-b-5 m-r-10">
									<select class="selection-2" name="kategori">
										<?php foreach ($kategori as $key => $value) : ?>
											<option value="<?php echo $value['id_kategori'] ?>" <?php if ($this->input->get('kategori') == $value['id_kategori']) {
																									echo "selected";
							...
							<div class="flex-w">
								<div class="rs2-select2 bo4 of-hidden w-size12 m-t-5 m-b-5 m-r-10">
									<select class="selection-2" name="sorting">
										<option value="" <?php if (!$this->input->get('sorting')) {
																echo "selected";
															} ?>>Default Sorting</option>
										<!-- <option>Popularity</option> -->
										<option value="asc" <?php if ($this->input->get('sorting') == "asc") {
																echo "selected";
															} ?>>Price: low to high</option>
										<option value="desc" <?php if ($this->input->get('sorting') == "desc") {
																	echo "selected";
